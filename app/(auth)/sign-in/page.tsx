  ...
  return (
    <div>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[#52526a] text-sm">Sign in to your account</p>
      </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          {/* Email */}
          <div className="mb-4">
            <label className="block text-xs font-semibold uppercase tracking-widest text-[#52526a] mb-2">
              Email
            </label>
            <input
              type="email"
              ...
              className="w-full rounded-xl px-4 py-2.5 text-sm text-white placeholder-[#303048] outline-none transition-all duration-200"
              style={{
                background: "#06060b",
                border: `1px solid ${errors.email ? "rgba(251,113,133,0.4)" : "rgba(255,255,255,0.07)"}`,
              }}
          ...
          <div className="mb-6">
            ...
            <input
              ...
              style={{
                background: "#06060b",
                border: `1px solid ${errors.password ? "rgba(251,113,133,0.4)" : "rgba(255,255,255,0.07)"}`,
              }}
              onFocus={(e) => { (e.target as HTMLInputElement).style.borderColor = "rgba(99,102,241,0.5)"; (e.target as HTMLInputElement).style.boxShadow = "0 0 0 3px rgba(99,102,241,0.1)"; }}
        ...
        <p className="mt-6 text-center text-sm text-[#303048]">
          ...
          <Link href="/sign-up" className="text-indigo-400 transition-colors duration-150 hover:text-indigo-300 font-medium">
            Sign up
          </Link>
        </p>
      </div>
